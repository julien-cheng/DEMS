namespace Documents.Clients.Tools.Commands
{
    ...
    public abstract class CommandBase
    {
        ...
        public UserIdentifier GetUserIdentifier(string identifier)
        {
            return GetIdentifier<UserIdentifier>(identifier,
                (i, value) => i.OrganizationKey = value ?? API.UserIdentifier.OrganizationKey,
                (i, value) => i.UserKey = value
            );
        }

        public FileIdentifier GetFileIdentifier(string identifier)
        {
            return GetIdentifier<FileIdentifier>(identifier,
                (i, value) => i.OrganizationKey = value ?? API.UserIdentifier.OrganizationKey,
                (i, value) => i.FolderKey = value,
                (i, value) => i.FileKey = value
            );
        }

        public FolderIdentifier GetFolderIdentifier(string identifier)
        {
            return GetIdentifier<FolderIdentifier>(identifier,
                (i, value) => i.OrganizationKey = value ?? API.UserIdentifier.OrganizationKey,
                (i, value) => i.FolderKey = value
            );
        }

        public OrganizationIdentifier GetOrganizationIdentifier(string identifier)
        {
            return GetIdentifier<OrganizationIdentifier>(identifier,
                (i, value) => i.OrganizationKey = value ?? API.UserIdentifier.OrganizationKey
            );
        }
    }
