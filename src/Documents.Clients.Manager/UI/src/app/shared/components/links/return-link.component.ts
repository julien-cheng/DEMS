...
@Component({
    ...
    template: `
        <a class="small" *ngIf="!!pathIdentifier" [routerLink]="routingArr" title="Return to {{text}}"><i [class]="iconClass"></i> <span>{{text}}</span></a>
  `,
...
export class ReturnLinkComponent implements OnInit {
    ...
    @Input() iconClass: string = 'fa fa-reply';
    @Input() text: string = 'Return';
    public routingArr = [];
    constructor() { }
