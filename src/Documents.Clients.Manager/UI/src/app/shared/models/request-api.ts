...
import { ItemQueryType, BatchRequest, BatchResponse, TIdentifierType, IOrganizationIdentifier, IFolderIdentifier, IPathIdentifier, IFileIdentifier } from '../index';

// Types:
// ---------------------------------------------
// export type EventType = 'initialize' | 'beforeSend' | 'send' | 'success' | 'error' | 'complete' | 'cancel';
export type BatchRequestFn = { BatchRequestType: { EventType: { fn: (batchRequest: BatchRequest) => boolean } } };
...
export const NoButtonRequestTypes: BatchRequestType[] = [
    'UploadRequest',
    'SearchRequest'
]
...
export const batchOperationsDefaults = {
    ...
    dialogMessages: { // If message exists here there will be a confirmation dialog.
        ...
        PublishRequest: 'You are about to share all the files in this package with all listed recipients. It is recommended that you draft a follow-up email to make these recipients aware of the new discovery package.',
    ...
    successMessages: { // To be used if needed
