...
export class BatchResponse {
  ...
  handleLoadingonCallback = false; // Leave the loading indicator for the callback call - success or error
  success = true;
  triggerSuccessEventOnSuccess = true; // Block requestType_success function on specific calls (initialize or send)
