...
@NgModule({
    imports: [
        ...
        // HttpModule,
        ReactiveFormsModule,
        RouterModule.forRoot(appRoutes, { preloadingStrategy: PreloadAllModules, onSameUrlNavigation: 'reload' }), // onSameUrlNavigation: 'reload' required for same url refresh (search results)
        SharedModule,
        ToastModule.forRoot(),
    ],
    declarations: [
