  ...
  template: `
    <div class="list-view">
      <ul class="list-unstyled">
        ...
        >
          <div class="pretty" *ngIf="hasRowsAllowedOperations">
            <input
              type="checkbox"
          ...
          <ng-container *ngIf="!row.editMode"> <app-link [row]="row" (triggerCallback)="saveCallback($event)"></app-link> </ng-container>
          <app-inline-editor
            [row]="row"
            [(ngModel)]="newName"
            label="{{row.name}}"
