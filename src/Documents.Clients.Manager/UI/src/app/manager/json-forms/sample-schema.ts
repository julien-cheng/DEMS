...
export const sampleSchema: Schema = {
  ...
  properties: {
    ...
    enumExample: {
      ...
      enum: [['One', 'enum 1'], ['Two', 'enum 2'], ['Three', 'enum 3'], ['Four', 'enum 4'], ['Five', 'enum 5']],
      default: 'enum 2',
    ...
    textareaExample: {
      ...
      default:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed lacinia magna non nulla accumsan ornare. Sed convallis lectus et dolor vestibulum, non fermentum felis eleifend.',
      maxLength: 250,
    ...
    booleanSelectOptionalExample: {
      // Select Control true/false options plus label with default option
      type: 'boolean',
      optional: true,
    ...
    integerExample2: {
      ...
      default: 4,
      optional: true,
      enum: [['One', 1], ['Two', 2], ['Three', 3], ['Four', 4], ['Five', 5]]
    },
    numberExample: {
      type: 'number',
      title: 'A number example',
    ...
    pets: {
      ...
      items: {
        ...
        properties: {
          type: {
            type: 'string',
            enum: [['cat', 'cat'], ['dog', 'dog'], ['bird', 'bird'], ['reptile', 'reptile'], ['other', 'other']]
          },
          name: {
            type: 'string'
