...
export class BaseControl implements IBaseControlOptions {
  ...
  constructor(key: string, controlSchema: Schema, formCustomValidators?: Array<ICustomValidator>, initialValues?: ValueType) {
  ...
  private _setFormControlInformation() {
    ...
    const inVal = this.initialValue !== undefined ? this.initialValue : this.defaultValue !== undefined ? this.defaultValue : undefined;
  ...
  private getDefaultValueByType(type: ControlType, inValue: ValueType) {
    ...
    switch (type) {
      case 'object':
        ...
        val = Array.isArray(inValue) && isObject(inValue[0]) ? inValue[0] : isObject(inValue) ? inValue : {};
      ...
      case 'integer':
        ...
        break;
      case 'boolean':
        val = typeof inValue === 'boolean' ? inValue : !!this.schema.optional && this.schema.optional ? null : false;
        break;
      case 'string':
